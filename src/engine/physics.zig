...
pub fn physicsSystem(comps: []const type, world: *World(comps), _: std.mem.Allocator) !void {
    ...
    while (it.next()) |entity| {
        ...
        while (it2.next()) |entity2| {
            ...
            if (nz.distance(bbaa, bbaa2) < bbaa.size + 2) {
                for (0..3) |i| {
        ...
        transform.position += rigidbody.force * delta_time;
